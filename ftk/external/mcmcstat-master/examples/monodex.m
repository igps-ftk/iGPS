...
data.xdata = [5 28    55    83    110   138   225   375 300]';   % x (mg / L COD) 
data.ydata = [0.01 0.0253 0.060 0.091312 0.105 0.099 0.122 0.125 0.14]'; % y (1 / h) 

%%
% Here is a plot of the data set.
figure(1); clf
plot(data.xdata,data.ydata,'s');
xlim([0 800]); xlabel('x [mg/L COD]'); ylabel('y [1/h]');
...
[tmin,ssmin]=fminsearch(ssfun,[0.03;100],[],data)
n = length(data.xdata);
p = 2;
