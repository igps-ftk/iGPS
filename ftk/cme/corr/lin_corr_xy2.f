      ...
      real*8 function lin_corr_xy2(mjd1,ts1,nmax1,nrow1,
...
c     get the same eopchs
      if (mjd1(nrow1).lt.mjd2(1).or.mjd2(nrow2).lt.mjd1(1)) then
         corr_xy=0
         write(*,*) ' [lin_corr_xy2] Warning: no common epochs'
...
c      write(*,*) '#common epochs:',nsame,nrow1,nrow2
      if (nsame.eq.0) then
         write(*,'(a)') ' [lin_corr_xy2] warning: no common epochs.'
         corr_xy=0
         goto 39
      endif
