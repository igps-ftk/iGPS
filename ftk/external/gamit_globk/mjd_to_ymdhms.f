CTITLE 'MJD_TO_YMDHMS'
 
      SUBROUTINE MJD_to_YMDHMS ( epoch, date, seconds )
...
*     CALLING SEQUENCE:
*     =================
*     CALL MJD_to_YMDHMS ( epoch, date, seconds )
*
*     WHERE:
...
* MOD TAH 090923: Try calc with +1 usec (0.01d-9 days)
     ...
     .                             - date(5)*60.d0 - dsec 
      ...
      if( seconds.lt.0 ) seconds = abs(seconds)   
