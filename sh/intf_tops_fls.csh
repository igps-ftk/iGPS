...
#
    ...
    if ($threshold_snaphu != 0 ) then
      #>added by tianyf/tyf on Mon Jun  8 22:49:40 CST 2020
      #set region_cut = `gmt grdinfo phase.grd -I- | cut -c3-20`
      #!!DO'NT change the default value of region_cut, otherwise the cut_slc
      #will be affected.
      #
      #thus, we use a second variable:
	...
	#echo ">>snaphu_fls.csh $threshold_snaphu $defomax $region_cut_snaphu"
        #snaphu_fls.csh $threshold_snaphu $defomax $region_cut_snaphu
        echo "gmtsar_fls.py $threshold_snaphu"
	#gmtsar_fls.py $threshold_snaphu -m snaphu -snaphu_alg MCF
        gmtsar_fls.py $threshold_snaphu
        \mv unwrap.grd _tmp_unwrap.grd
        gmt grdtrend _tmp_unwrap.grd -N3r -Dunwrap.grd
        \rm _tmp_unwrap.grd
...
#
  ...
  #>added by tianyf/tyf on Sun Jun 21 11:25:20 CST 2020
  #clean unnecessary files
  echo "sh_sar_clean_intf intf/$ref_id"_"$rep_id"
  sh_sar_clean_intf intf/$ref_id"_"$rep_id
  #<
  ...
  #set oldpath = `pwd`
  #cd intf_all
  #echo sh_sar_clean_intf_all_merge
  #echo sh_sar_clean_intf_all_merge | sh
