PRO  WRITE_VEL_PROFILE, ofile $
  ...
  WRITE_SYS_INFO,fid,prog=prog,src=headers,user=user
  ...
  PRINTF,fid,labels_description[0,*],  $
    format='("*",a9,(1x,a8),(1x,a7),1x,a7,2(1x,a7),2(1x,a7),2(1x,a7),(1x,a8),(1x,a7),1x,a9, 2(1x,a7),6(1x,a7),1x,a6)'
  ...
  FOR j=0, N_ELEMENTS(odata[0,*])-1 DO BEGIN
    ...
    PRINTF,fid,sites[j],odata[*,j],$
      format='(1x,a9, (1x,f8.3),(1x,f7.3), 1x,f7.2, 2(1x,f7.2),2(1x,f7.2),2(1x,f7.2), (1x,f8.3),(1x,f7.3), 1x,f9.3,2(1x,f7.2),6(1x,f7.2),1x,f6.3)'
  ENDFOR
  FREE_LUN,fid
;stop
END