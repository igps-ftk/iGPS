...
paths={'D:\gsar\gic3dv\xsh\profiles\p.fa_xsh_b_chuandian'};
paths={'Z:\g11j\D\gsar\gic3dv\xsh\profiles\p.fa_xsh_b_aba'};
paths={'Z:\g11j\D\gsar\gic3dv\xsh\profiles\p.fa_xsh_b'};
ptn='0';
% dmin=-200;
% dmax=200;
dmin=-1000;
