...
#
#       python ./download-all-2023-02-18_15-38-36.py
#
#    Download all files in a Metalink/CSV: (downloaded from ASF Vertex)
#
#       python ./download-all-2023-02-18_15-38-36.py /path/to/downloads.metalink localmetalink.metalink localcsv.csv
#
...
class bulk_downloader:
    def __init__(self):
        ...
        self.files = [ "https://datapool.asf.alaska.edu/SLC/SA/S1A_IW_SLC__1SDV_20200726T000952_20200726T001019_033618_03E572_17E0.zip",
                       "https://datapool.asf.alaska.edu/SLC/SA/S1A_IW_SLC__1SDV_20200714T000951_20200714T001018_033443_03E012_72CA.zip" ]
