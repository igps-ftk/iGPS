c     error:
c     The results was two days bigger.
c     Mon Nov 17 10:38:15 CST 2008

CTITLE 'YMDHMS_TO_JD'
 
      SUBROUTINE YMDHMS_to_JD_noy2k ( date, seconds, epoch )
*     -------------------------
*    .,      26JUL85                <871210.1317>
...
c      if( year.lt.50 ) then
c          year = year + 2000
c      else if ( year.lt. 200 ) then
c          year = year + 1900
c      end if
