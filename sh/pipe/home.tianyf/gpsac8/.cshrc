...
setenv IGS_ROOT /g8b/gsar/igs

setenv igps_arp /g8n/arp
...
#set path=(/usr/local/GMT-5.4.2i/bin $path)
#set path=(/home/tianyf/this_gmt/bin $path)
#set GMT=/usr/local/GMT-5.4.2i/
...
#setenv GMT5SAR /usr/local/gmt5sar20170330Ti
#setenv GMT5SAR /usr/local/gmt5sar20170525
...
#setenv GMT5SAR /usr/local/gmt5sar20210123
#setenv GMT5SAR /usr/local/gmt5sar20210607i
setenv GMT5SAR /usr/local/gmt5sar20220909
...
#setenv http_proxy 'http://192.168.11.33:/8889'
#setenv https_proxy 'http://192.168.11.33:/8889'
...
#if ( -f "/usr/local/anaconda3/etc/profile.d/conda.csh" ) then
#    source "/usr/local/anaconda3/etc/profile.d/conda.csh"
#else
#    setenv PATH "/usr/local/anaconda3/bin:$PATH"
#endif
# <<< conda initialize <<<
