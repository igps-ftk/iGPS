PRO YMDHMS_TO_MJD , date, seconds, epoch
  ...
  ;*     CALLING SEQUENCE:
  ;*     =================
  ;*      ymdhms_to_JD , date, seconds, epoch
  ;*
  ;*     WHERE:
  ...
  days_from_1600 = years_from_1600*365d  + leap_days + $
  ...
  fraction  = seconds/86400.d  + date(4)/1440.d + date(3)/24.d
  
  mjd   = -94554.d + days_from_1600 + fraction
  epoch = mjd
