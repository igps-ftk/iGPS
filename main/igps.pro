...
PRO IGPS_EVENT, EV
  ...
  CASE WTARGET OF
    ...
    END
    WIDGET_INFO(WWIDGET, FIND_BY_UNAME='MNU_DATA_GPS_VEL_PROFILE'): BEGIN
      IF( TAG_NAMES(EV, /STRUCTURE_NAME) EQ 'WIDGET_BUTTON' )THEN $
        ON_IGPS_MNU_GPS_VEL_PROFILE, EV
    END
...
PRO IGPS
  ...
  MNU_DATA_GPS_VEL_PROFILE = WIDGET_BUTTON ( MNU_DATA , $
    UNAME = 'MNU_DATA_GPS_VEL_PROFILE', VALUE='GPS Velocity Profiles Creator')
